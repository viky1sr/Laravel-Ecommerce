...
class CreateOrderDetailsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('order_details', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('orders_id'); //FIELD INI AKAN MERUJUK KE TABLE orders
            $table->unsignedBigInteger('products_id'); //FIELD INI AKAN MERUJUK KE TABLE products
